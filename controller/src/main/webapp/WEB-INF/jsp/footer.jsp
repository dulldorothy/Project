        ...
        <div class="footer-container">
            ...
            <div class="part1">
                <ul class="social-list">
                    ...
                    <li class="social-li-element"> <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                        <g fill="none" fill-rule="nonzero">
                            <circle cx="18" cy="18" r="17.5" stroke="#FFF" />
                            <path fill="#FFF"
            ...
            <div class="part2">
                <ul class="terms">
                    <li class="terms-element">About</li>
                    <li class="terms-element">Status</li>
                    <li class="terms-element">Terms</li>
                </ul>
            </div>
            <div class="part3">
